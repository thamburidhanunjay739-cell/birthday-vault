...
const CHAPTERS = [
  ...
  { year: "2023", label: "Chapter III", title: "The Deep Stuff",       body: "3rd year. Long practicals, failed exams, 2am panic calls. Every single hard moment was easier just because you were there — quietly, without question." },
